...
#play again button
again_rect = Rect(screen_width // 2 - 80, screen_hieght // 2 + 80, 160, 50)
...
def draw_winner(winner):
    ...
    pygame.draw.rect(screen, green, (screen_width // 2 - 100, screen_hieght // 2 - 60, 200, 50))
    screen.blit(win_img, (screen_width // 2 - 100, screen_hieght // 2 - 50))
    
    again_text = "Play Again?"
    again_img = font.render(again_text, True, blue)
    pygame.draw.rect(screen, green, again_rect)
    screen.blit(again_img, (screen_width // 2 - 80, screen_hieght // 2 + 90))
